import { Avatar, Card, Chip, Tooltip, Typography } from "@mui/joy";
...
const RewardLog = ({ log }: I_RewardLogProps) => {
  return (
    <Card sx={{ p: 1, flexDirection: "row", gap: 1, alignItems: "center" }}>
      ...
      <Tooltip disableInteractive arrow title={log.playerName} placement="top">
        <Avatar
